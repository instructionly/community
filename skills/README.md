...
A collection of ready-to-use skills for Instructionly, created and maintained by the community.
...
5. In Instructionly, go to **Skills** → **Import**
...
2. In Instructionly, go to **Skills** → **Import**
...
Want a skill that doesn't exist? Open a [Discussion](https://github.com/instructionly/community/discussions) with the "Skill Request" category.
